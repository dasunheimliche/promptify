...
const Mutation = {
  ...
  createAi: async (
    ...
    const nuevaAi = await newAi.save().catch((error) => {
      throw new GraphQLError("Creating the user failed", {
        extensions: {
          code: "BAD_USER_INPUT",
          invalidArgs: args,
  ...
  createTopic: async (
    ...
    const nuevoTopic: Document<Topic> = await newTopic.save().catch((error) => {
      throw new GraphQLError("Creating the user failed", {
        extensions: {
          code: "BAD_USER_INPUT",
          invalidArgs: args,
  ...
  createCard: async (
    ...
    const nuevaCard = await newCard.save().catch((error) => {
      throw new GraphQLError("Creating the user failed", {
        extensions: {
          code: "BAD_USER_INPUT",
          invalidArgs: args,
